...
제안 주소는 `ws://canvas:8762/commands/{session_id}`다. 캔버스가 사용하는 필드는
...
3. 전체 Docker 빌드 및 8000/8760/8762 health 확인
