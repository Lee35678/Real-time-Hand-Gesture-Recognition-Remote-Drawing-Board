...
config/canvas.yaml > 이 파일의 코드 기본값 (containers/2-vision-analysis/app/config/__init__.py
와 동일 패턴).
...
`containers/3-pattern-command`를 `sys.path`에 얹어 `gesture_classifier`를 가져오는데,
